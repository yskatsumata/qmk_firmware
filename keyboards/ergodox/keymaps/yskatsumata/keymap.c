 ...
 * `--------+------+------+------+------+-------------'           `-------------+------+------+------+------+--------'
 *   | Ctrl | GUI  |AltShf| Alt  |MHEN/Ctrl |                                   |Ent/L2| Down |   [  |   ]  | ~L1  |
 *   `----------------------------------'                                       `----------------------------------'
 *                                        ,-------------.       ,-------------.
 *                                        | App  | LGui |       | Alt  | App  |
 *                                 ,------|------|------|       |------+--------+------.
...
[BASE] = KEYMAP(  // layer 0 : default
        ...
        KC_LCTRL,       KC_LGUI,      LALT(KC_LSFT),   KC_LALT,CTL_T(KC_MHEN),
                                              GUI_T(KC_APP),  KC_LGUI,
                                                              KC_HOME,
                                               KC_SPC,KC_DEL,LT(MDIA,KC_TRNS),
        // right hand
             KC_RGHT,     KC_6,   KC_7,  KC_8,   KC_9,   KC_0,             KC_MINS,
             TG(SYMB),    KC_Y,   KC_U,  KC_I,   KC_O,   KC_P,             KC_EQUAL,
                          KC_H,   KC_J,  KC_K,   KC_L,   KC_SCLN,          GUI_T(KC_QUOT),
             MEH_T(KC_NO),KC_N,   KC_M,  KC_COMM,KC_DOT, CTL_T(KC_SLSH),   KC_BSLS,
                                  LT(MDIA,KC_ENT),KC_DOWN,KC_LBRC,KC_RBRC,KC_FN1,
             KC_LALT,        KC_APP,
             KC_PGUP,
 ...
 * |        |      |      |      |      |      |      |           |      |      |      |      |      |      |        |
 * |--------+------+------+------+------+-------------|           |------+------+------+------+------+------+--------|
 * |        |      |      | MsUp |      | MW_D |VolUp |           |      |      | PgUp |  Up  | PgDn |      |        |
 * |--------+------+------+------+------+------|      |           |      |------+------+------+------+------+--------|
 * |        |      |MsLeft|MsDown|MsRght| MW_U |------|           |------| Home | Left | Down | Right| End  |  Play  |
 * |--------+------+------+------+------+------|VolDn |           |      |------+------+------+------+------+--------|
 * |        |      |      |      |      |      |      |           |      |      |      | Prev | Next |      |        |
 * `--------+------+------+------+------+-------------'           `-------------+------+------+------+------+--------'
 *   |      |      |      |      | Rclk |                                       |      |      | Mute |      |      |
...
[MDIA] = KEYMAP(
       ...
       KC_TRNS, KC_TRNS, KC_TRNS, KC_MS_U, KC_TRNS, KC_MS_WH_DOWN, KC_VOLU,
